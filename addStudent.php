<?php require('header.php'); ?>
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i>Add Student</h2>
...
$rid=$_POST['registrationid'];
$branch=$_POST['dept'];

$db = mysql_select_db("capeplacementcell", $conn);

// SQL query to fetch information of registerd users and finds user match.
$query = mysql_query("INSERT INTO capeplacementcell.studtable(`regid`, `fname`, `Dept`, `email`, `studpswd`) VALUES ('$rid','$first_name','$branch','$mail','$pswd');", $conn);
...
echo "                                </div>\n"; 
echo "                                <div class=\"form-group\">\n"; 
echo "                                    <label class=\"sr-only\" for=\"department\">Department</label>\n"; 
...
echo "                                    <input type=\"text\" name=\"registrationid\" placeholder=\"Registration ID\" \n"; 
echo "                                    	                 class=\"f1-about-yourself form-control\" id=\"registrationid\"></input>\n"; 
echo "                                </div>\n";
echo "                            </fieldset>\n"; 
echo "\n"; 
echo "                            <fieldset>\n"; 
