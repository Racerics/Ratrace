<?php require('header.php');
 ...
 ?>
	...
	<?php
		...
		echo "\n";
	?>
	<a class=\"btn btn-success\" href="newmsgs.php"> <i class="glyphicon glyphicon-star"></i>New Message
			</a>
        <div class="box-icon">
...
<?php
$check="Admin";
$que="SELECT * FROM capeplacementcell.mtable WHERE mtable.receiver='{$check}' ORDER BY mtable.datem DESC ";
