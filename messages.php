<?php require('header.php');
		if(isset($_GET['did'])){
			$userid=$_GET['did'];
			$s=$_GET['dat'];
	$squery=mysql_query("DELETE FROM capeplacementcell.mtable WHERE msgtable.receiverid={$userid} AND mtable.mdate={$s}",$conn);
	}
 ?>
    <div>
        <ul class="breadcrumb">
    ...
    <tbody>
<?php
$que="SELECT * FROM capeplacementcell.mtable WHERE mtable.receiverid={$user_check} ORDER BY mtable.datem DESC ";
