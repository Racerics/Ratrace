<?php require('header.php'); 
	...
	// builds the query
    $query = "SELECT DISTINCT s.regid AS regid, s.fname AS fname,`Dept`,email,Mob FROM capeplacementcell.studtable s LEFT JOIN capeplacementcell.appliedtable a ON s.regid=a.regid WHERE ";
    // define the list of fields
	if(isset($_POST['cname'])){
		$query .=" a.cname LIKE '%" . mysql_real_escape_string($_POST['cname']) . "%'";
	}
