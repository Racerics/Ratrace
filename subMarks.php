...
?>
    <div>
        <ul class="breadcrumb">
            ...
            <li>
                <a href="subMarks.php">Submit Marks</a>
            </li>
...
$de=mysql_query("SELECT Dept FROM capeplacementcell.studtable WHERE regid={$user_check};",$conn);
$dep=mysql_fetch_array($de);
$d=$dep['Dept'];
// SQL query to fetch information of registerd users and finds user match.
	$inst="INSERT INTO capeplacementcell.marktable( `regid`, `Dept`, `Sem`, `Sub1`, `Sub2`, `Sub3`, `Sub4`, `Sub5`, `Sub6`, `L1`, `L2`, `GPA`, `Eligibility`) VALUES ('$user_check','$d','$sem','$one','$two','$three','$four','$five','$six','$lab1','$lab2','$gpa','$elig')";
